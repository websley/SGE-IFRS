...
class Estagios_model extends CI_Model {
	...
	function getEstagios(){
		...
		return $this->db->query('
			select id_estagio, a.nome as nome_aluno, data_inicio, data_termino, data_desistencia ,obrigatorio,
	...
	function contabiliza_horas($d){
		...
		$this->db->query(' update aluno set horas_estagio = horas_estagio + '.$horas_estagio.' where id_aluno = '.$d['id_aluno']);		
	}
}
