<div id="modal-adiciona-documento" class="modal fade" tabindex="-1" role="dialog" aria-hidden="true">
	<div class="modal-dialog modal-xl" role="document">

			<div class="modal-content">
				<div class="modal-header">
							<h5 class="modal-title text-primary" id="myModalLabel">Cadastro de documento</h5>
					<button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
				</div>
				<div class="modal-body" >

	<form id="form_novo_doc" class="needs-validation" onsubmit="return false;" method="POST" enctype="multipart/form-data" novalidate>
				...
				<div class="accordion" id="accordionExample">
				 <div class="card">
				  ...
				  <div class="card">
					...
					{EMPRESA_REPRESENTANTE_CPF}<br>
					{EMPRESA_REPRESENTANTE_RG}<br>
					{EMPRESA_REPRESENTANTE_DATA_EXPEDICAO}<br>
					{EMPRESA_REPRESENTANTE_ORGAO_EMISSOR}<br>
					  </div>
					</div>
				  </div>
				  <div class="card">
